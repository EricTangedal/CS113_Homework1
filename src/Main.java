...
public class Main {
    public static void main(String[] args){
        ...
        //polynomialString = input.nextLine();

        //iterate through string
        //store coefficient and exponent into new Term
        //store Terms into new Polynomial using array or arrayList

        //Test Term
        System.out.println("To test the Term and Polynomial classes, we will create, store, and display a polynomial with 3 terms." +
        ...
        testTermArrayList = new ArrayList<Term>();
        ...
        //TEST
        //take in polynomial with 3 terms, first term has exponent, second term does not have exponent, third term is integer.
    }
}
